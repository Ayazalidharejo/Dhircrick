            ...
            <Grid item xs={12} md={9}>
              <div className="d-flex justify-content-between align-items-center mt-5">
                <div className="text-black fw-bold  hide-xs">
                  <span>Home</span> / <span>Lawn, Patio & Garden</span>
                </div>
                ...
                {filteredProducts.map((product, index) => (
                  <Grid item xs={6} sm={6} md={4} lg={columnsPerRow === 6 ? 2 : 3} key={index}>
                    <Box className="card p-3 shadow-sm border-0 d-flex align-items-center">
                      ...
                      />
                      {product.discount && (
                        <span className="badge text-white btn-color position-absolute">{product.discount}</span>
                      )}
...
export default Lawnpatioparden;
